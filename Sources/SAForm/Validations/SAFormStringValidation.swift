...
public extension SAFormValidationRules {
    ...
    func string() -> SAFormStringValidation {
        .init()
    }
}

/// A validation builder for `String` values that supports composing multiple rules.
public struct SAFormStringValidation: SAFormValidationTypeRules {
    public var rules: [(_ value: String) async -> SAFormValidationResponse<String>] = []
